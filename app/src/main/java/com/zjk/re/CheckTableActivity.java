            ...
            if(ct.getFlag()==1){
				...
				imageView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View view) {
						...
						intent.setClass( CheckTableActivity.this,OrderActivity.class);
					...
					.setPositiveButton("确定", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							...
							if (isChangeTable(orderId, tableId)) {
								...
								Toast.
										makeText(CheckTableActivity.this, "输入有误！请重新输入", Toast.LENGTH_LONG).show();
			...
			//设置输入框visibility，other-invisible,1-visible,2-gone
			       ...
			       .setPositiveButton("确定", new DialogInterface.OnClickListener() {
					   public void onClick(DialogInterface dialog, int id) {
						   ...
						   orderId = result;
						   Toast.
								   makeText(CheckTableActivity.this, "开桌成功！你的订单号：" + result, Toast.LENGTH_LONG).show();
						   //重绘girdview
						   //清空tablelist
						   list.clear();
						   //table再次获取list
	...
	private void updateMenu() {
		...
		try {
			...
			for (int i = 0; i < nl.getLength(); i++) {
               ...
               //弹出toast
				Toast
						.makeText(CheckTableActivity.this, "更新成功", Toast.LENGTH_LONG).show();
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
